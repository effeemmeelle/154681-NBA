...
for(i in 1:nrow(correlazione_df)) {
    ...
    if(abscor > 0.09)
      cat(paste0("<tr><td>", stat, "</td><td>", round(correlazione_df$correlazione[i], digits=3), "</td><td>", cor.test(dataframe[[stat]], dataframe$Altezza_cm)$p.value, "</td></tr>"))
}
...
for(i in 1:nrow(correlazione_df)) {
    ...
    abscor <- abs(correlazione_df$correlazione[i])
    if(abscor > 0.10)
      cat(paste0("<tr><td>", stat, "</td><td>", round(correlazione_df$correlazione[i], digits=3), "</td><td>", cor.test(dataframe[[stat]], dataframe$Altezza_cm, method="kendall")$p.value, "</td></tr>"))
}
